...
void loop(void)
{
  ...
  while ( (packetSize = UdpData.parsePacket()) > 0)
  {
    ...
    int value = arr[0];
    int servoIndex = arr[1];

    int servoValue = constrain(SERVO_INIT_VALUE + value, 0, 180);
